...
def get_credentials(email: str, db: Session = Depends(get_db)):
    """
    Retourne les credentials (dont le password_hash) pour vérification au login.
    Protégé par verify_internal_secret — ne doit JAMAIS être exposé publiquement via la gateway.
    """
